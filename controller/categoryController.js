...
module.exports={
    ...
    getCategory: async (req, res) => {
        try {
            ...
            res.render("admin/category",{cat:category,error:req.flash("error")})
...
//get addd category
    ...
    postAddcategory : async (req,res)=>{
        try{
            ...
            const categoryDetails = await catModel.findOne({category:req.body.category.toUpperCase()})
            if(categoryDetails){
    ...
    getEditcategory : async(req,res)=>{
        try{
            ...
            res.render("admin/updatecategory",{itemcat: cat,error:req.flash("error")})
        }catch(error){
    ...
    postEditcategory :async (req,res)=>{
        try{
            ...
            if(existingCat){
             ...
             await catModel.updateOne({_id:id},{$set:{category:newCatName,description:catdes}})
             res.redirect("/category")
            }
